      ...
      <footer className="Coffee__Footer">
        ...
        <nav>
          <ul>
            ...
            <Link to="/Terms"><li>Terminos y Condiciones</li></Link>
            <Link to="/AboutUs"><li>Sobre Nosotros</li></Link>
          </ul>
        </nav>
        <p>
          © Chiarelli Coffee - Este es un proyecto ficticio para el curso de
          React de Coderhouse. Todos los derechos reservados. Todas las marcas
          comerciales y marcas registradas son propiedad de sus respectivos
          dueños.
        </p>
      </footer>
    );
